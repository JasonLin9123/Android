...
public class CalculatorTest {
    ...
    public void mulTwoNumbers() {
        double resultPow = mCalculator.mul(32d, 2d);
    ...
    public void powTwoNumbersZeroSecond() {
        double resultPow = mCalculator.pow(10d, 0d);
        assertThat(resultPow, is(equalTo(1d)));
    }
    @Test
    public void powTwoNumbersNegativeError() {
        double resultPow = mCalculator.div(0d,-1d);
        assertThat(resultPow, is(equalTo(-0d)));
    }
    @Test
    public void powTwoNumbersNegativeZero() {
        double resultPow = mCalculator.pow(-0d, -3d);
