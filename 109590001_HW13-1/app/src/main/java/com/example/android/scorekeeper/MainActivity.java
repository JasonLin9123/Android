...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mPreferences.contains("Team1")){
            mScore1 = mPreferences.getInt("Team1", 0);
            mScoreText1.setText(String.valueOf(mScore1));
        }
        if(mPreferences.contains("Team2")){
            mScore2 = mPreferences.getInt("Team2", 0);
    ...
    public void decreaseScore(View view) {
        ...
        switch (viewID) {
            ...
            case R.id.decreaseTeam1:
                ...
                mScore1--;
                preferencesEditor.putInt("Team1", mScore1);
            ...
            case R.id.decreaseTeam2:
                // Decrement the score and update the TextView.
                mScore2--;
                preferencesEditor.putInt("Team2", mScore2);
                preferencesEditor.apply();
                mScoreText2.setText(String.valueOf(mScore2));
        }
    }
