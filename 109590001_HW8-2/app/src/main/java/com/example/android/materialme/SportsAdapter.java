...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            View imageView = view.findViewById(R.id.sportsImage);
            ...
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(activity, imageView, "example_transition");
